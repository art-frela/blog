...
func testUserToManyAuthorComments(t *testing.T) {
	var err error
	ctx := context.Background()
	tx := MustTx(boil.BeginTx(ctx, nil))
	defer func() { _ = tx.Rollback() }()
	...
	slice := UserSlice{&a}
	if err = a.L.LoadAuthorComments(ctx, tx, false, (*[]*User)(&slice), nil); err != nil {
		t.Fatal(err)
	}
...
func testUserToManyAuthorPosts(t *testing.T) {
	var err error
	ctx := context.Background()
	tx := MustTx(boil.BeginTx(ctx, nil))
	defer func() { _ = tx.Rollback() }()
	...
	slice := UserSlice{&a}
	if err = a.L.LoadAuthorPosts(ctx, tx, false, (*[]*User)(&slice), nil); err != nil {
		t.Fatal(err)
	}
...
func testUserToManyAddOpAuthorComments(t *testing.T) {
	var err error
...
func testUserToManySetOpAuthorComments(t *testing.T) {
	var err error
	...
	err = a.SetAuthorComments(ctx, tx, false, &b, &c)
	if err != nil {
		t.Fatal(err)
	}
	...
	err = a.SetAuthorComments(ctx, tx, true, &d, &e)
	if err != nil {
		t.Fatal(err)
	}
	...
	if a.R.AuthorComments[0] != &d {
		t.Error("relationship struct slice not set to correct value")
	}
	if a.R.AuthorComments[1] != &e {
		t.Error("relationship struct slice not set to correct value")
	}
}

func testUserToManyRemoveOpAuthorComments(t *testing.T) {
	var err error
	...
	err = a.AddAuthorComments(ctx, tx, true, foreigners...)
	if err != nil {
		t.Fatal(err)
	}
	...
	err = a.RemoveAuthorComments(ctx, tx, foreigners[:2]...)
	if err != nil {
		t.Fatal(err)
	}
	...
	if len(a.R.AuthorComments) != 2 {
		t.Error("should have preserved two relationships")
	}

	// Removal doesn't do a stable deletion for performance so we have to flip the order
	if a.R.AuthorComments[1] != &d {
		t.Error("relationship to d should have been preserved")
	}
	if a.R.AuthorComments[0] != &e {
		t.Error("relationship to e should have been preserved")
	}
}

func testUserToManyAddOpAuthorPosts(t *testing.T) {
	var err error
...
func testUserToManySetOpAuthorPosts(t *testing.T) {
	var err error
...
func testUserToManyRemoveOpAuthorPosts(t *testing.T) {
	var err error
...
var (
	userDBTypes = map[string]string{`ID`: `varchar`, `Username`: `varchar`, `Nick`: `varchar`, `Email`: `varchar`, `CreatedAt`: `datetime`, `ModifiedAt`: `datetime`, `UserRole`: `int`, `Salt`: `varchar`, `AvatarURL`: `varchar`}
	_           = bytes.MinRead
)
